...
import { ArrowLeft, Loader2, AlertTriangle, RefreshCw, Mail, Clock } from "lucide-react"
...
export default function LoginPage() {
  ...
  const handleResendVerification = async () => {
    ...
    setLoading(true);
    try {
      await updateLoadingText('Processing...', 500);
      
      // Try a direct passwordless sign-in which will work regardless of whether
      // the user is new or existing
      await updateLoadingText('Preparing verification email...', 800);
      ...
      await updateLoadingText('Verification email sent!', 800);
      
      // Close expired dialog and show verification sent dialog
      setShowExpiredLinkDialog(false);
      setShowVerificationSentDialog(true);
      
      toast({
        title: "Verification Email Sent",
        description: "Please check your inbox and click the link to continue.",
      });
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      {/* Expired Link Dialog */}
      <AlertDialog open={showExpiredLinkDialog} onOpenChange={setShowExpiredLinkDialog}>
        <AlertDialogContent className="bg-[#0F1116] border border-gray-800 rounded-2xl max-w-md mx-auto p-6 shadow-2xl">
          <div className="flex flex-col items-center gap-6">
            {/* Icon */}
            <div className="w-12 h-12 bg-[#1A1D24] rounded-full flex items-center justify-center">
            ...
            <div className="text-center">
              ...
              <div className="w-12 h-0.5 bg-amber-500/30 mx-auto"></div>
            </div>
            ...
            <div className="w-full">
              ...
              <Input 
                ...
                className="bg-[#1A1D24] border-gray-800 text-white w-full"
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                required
              />
            ...
            <div className="flex flex-col gap-3 w-full">
              <Button
                ...
                className="w-full bg-amber-600 hover:bg-amber-700 text-white py-2 rounded-lg font-medium flex items-center justify-center gap-2"
                disabled={!email}
              >
              ...
              <div className="flex gap-3 w-full">
                <Button
                  onClick={() => setShowExpiredLinkDialog(false)}
                  className="flex-1 bg-[#1A1D24] hover:bg-gray-800 text-white border border-gray-800"
                >
                  Cancel
                </Button>
                <Button
