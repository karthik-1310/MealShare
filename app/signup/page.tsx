        ...
        >
          ...
          <Card className="bg-gray-900/70 border-gray-800 relative">
            <CardHeader className="text-center">
              ...
              <CardDescription>Join MealShare today</CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="email" className="w-full">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Input type="text" placeholder="First Name" className="bg-gray-800 border-gray-700" />
                      </div>
                      <div className="space-y-2">
                        <Input type="text" placeholder="Last Name" className="bg-gray-800 border-gray-700" />
                      </div>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <Input type="password" placeholder="Confirm Password" className="bg-gray-800 border-gray-700" />
                    </div>
                ...
                <TabsContent value="phone">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Input type="text" placeholder="Full Name" className="bg-gray-800 border-gray-700" />
                    </div>
                    <div className="space-y-2">
